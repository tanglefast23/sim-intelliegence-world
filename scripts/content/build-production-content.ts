...
const CHARACTER_VOICE = {
  ...
  devon_price: {
    personality: 'Devon is charming, guarded, and excellent at changing a subject without appearing to. He values discretion more than approval.',
    biography: 'Devon tends bar on the downtown club strip. He knows public nightlife, staff signals, and which rumors are unsafe to repeat. He has loose ties to Velvet Tide but no authority to reveal its private operations. He is not romantically available to the protagonist.',
    reasoning: 'Devon reads risk and social leverage well. He avoids claims that could put him or a coworker in danger.',
    education: 'Secondary school, hospitality work, licensing courses, and long experience with nightlife customers.',
    ...
    greeting: 'Famous mistake, right? Downtown has seen worse branding.',
  },
  priya_nair: {
