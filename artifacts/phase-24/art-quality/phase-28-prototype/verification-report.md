...
8. Pass. Legacy and enhanced maximum-load modes both measure 119.9 FPS, with 8.3 ms median frame time in both modes. The median ratio is 1.0. Enhanced art adds one static batch. Both reports pin the same commit, package payload, map, camera, window, DPR, and zoom. Natural movement records 119.9 FPS under the mandatory `qualification` profile and passes its 55 FPS floor.
